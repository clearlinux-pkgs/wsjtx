...
Version  : 2.2.0
Release  : 6
URL      : https://sourceforge.net/projects/wsjt/files/wsjtx-2.2.0/wsjtx-2.2.0.tgz
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.2.0/wsjtx-2.2.0.tgz
...
%prep
%setup -q -n wsjtx-2.2.0
cd %{_builddir}/wsjtx-2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591312355
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wsjtx-2.2.0/COPYING %{buildroot}/usr/share/package-licenses/wsjtx/adb8e66537b20965af9486caf935e5194245b366
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
