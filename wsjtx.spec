...
Version  : 2.7.0.rc6
Release  : 35
URL      : https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0-rc6/wsjtx-2.7.0-rc6.tgz
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0-rc6/wsjtx-2.7.0-rc6.tgz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721417349
mkdir -p clr-build
pushd clr-build
