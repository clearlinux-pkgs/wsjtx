...
Version  : 2.7.0
Release  : 38
URL      : https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0/wsjtx-2.7.0.tgz
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0/wsjtx-2.7.0.tgz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739832822
mkdir -p clr-build
pushd clr-build
