...
Version  : 2.1.0
Release  : 4
URL      : https://sourceforge.net/projects/wsjt/files/wsjtx-2.1.0/wsjtx-2.1.0.tgz
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.1.0/wsjtx-2.1.0.tgz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563575804
mkdir -p clr-build
pushd clr-build
