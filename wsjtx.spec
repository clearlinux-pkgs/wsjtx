...
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.5.2/wsjtx-2.5.2.tgz
...
%prep
%setup -q -n wsjtx-2.5.2
cd %{_builddir}/wsjtx-2.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636568950
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wsjtx-2.5.2/COPYING %{buildroot}/usr/share/package-licenses/wsjtx/adb8e66537b20965af9486caf935e5194245b366
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build-avx512
