...
Version  : 2.4.0
Release  : 11
URL      : https://sourceforge.net/projects/wsjt/files/wsjtx-2.4.0/wsjtx-2.4.0.tgz
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.4.0/wsjtx-2.4.0.tgz
...
%prep
%setup -q -n wsjtx-2.4.0
cd %{_builddir}/wsjtx-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622063406
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wsjtx-2.4.0/COPYING %{buildroot}/usr/share/package-licenses/wsjtx/adb8e66537b20965af9486caf935e5194245b366
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
