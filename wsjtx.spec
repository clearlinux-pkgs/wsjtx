...
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.2.1/wsjtx-2.2.1.tgz
...
%prep
%setup -q -n wsjtx-2.2.1
cd %{_builddir}/wsjtx-2.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591631670
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wsjtx-2.2.1/COPYING %{buildroot}/usr/share/package-licenses/wsjtx/adb8e66537b20965af9486caf935e5194245b366
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
