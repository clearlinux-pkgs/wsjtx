...
Version  : 2.7.0.rc8
Release  : 37
URL      : https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0-rc8/wsjtx-2.7.0-rc8.tgz
Source0  : https://sourceforge.net/projects/wsjt/files/wsjtx-2.7.0-rc8/wsjtx-2.7.0-rc8.tgz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736181967
mkdir -p clr-build
pushd clr-build
